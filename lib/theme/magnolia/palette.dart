...
class PrimaryColor {
  ...
  final primary = const Color(0xFF78E6BE);

  /// #131C2F ![](https://dummyimage.com/24/EBF3F9.png&text=+)
  final sea = const Color(0xFFEBF3F9);
...
class SecondaryColor {
  ...
  /// #7590E0 ![](https://dummyimage.com/24/0B1B25.png&text=+)
  final bay = const Color(0xFF0B1B25);
