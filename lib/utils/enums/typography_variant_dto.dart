...
class TypographyVariantEnum extends EnumDto<TypographyVariant> {
  @override
  ...
  @override
  TypographyVariant? canParse(String enumType) {
    switch (enumType) {
      case "h1":
  ...
  @override
  TypographyVariant get defaultEnum => TypographyVariant.cta;
}
